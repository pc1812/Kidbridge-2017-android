...
public abstract class CalendarViewPager extends ViewPager {
    ...
    public CalendarViewPager(Context context, AttributeSet attrs) {
        ...
        //不是本月的颜色
        Attrs.hintColor = ta.getColor(R.styleable.NCalendar_hintColor, getResources().getColor(R.color.white));
        Attrs.solarTextSize = ta.getDimension(R.styleable.NCalendar_solarTextSize, RUtils.sp2px(context, 14));
        Attrs.lunarTextSize = ta.getDimension(R.styleable.NCalendar_lunarTextSize, RUtils.sp2px(context, 8));
        Attrs.selectCircleRadius = ta.getInt(R.styleable.NCalendar_selectCircleRadius, (int) RUtils.dp2px(context, 20));
        Attrs.isShowLunar = ta.getBoolean(R.styleable.NCalendar_isShowLunar, true);
        Attrs.pointSize = ta.getDimension(R.styleable.NCalendar_pointSize, (int) RUtils.dp2px(context, 2));
        ...
        Attrs.hollowCircleStroke = ta.getInt(R.styleable.NCalendar_hollowCircleStroke, (int) RUtils.dp2px(context, 1));
        Attrs.pushColoe = ta.getColor(R.styleable.NCalendar_pushcardcolor,getResources().getColor(R.color.selectCircleColor));
    ...
    public abstract void setPushDate(List<DateTime> date);
    public abstract void setChangeDate(Map<DateTime,Integer> map);
