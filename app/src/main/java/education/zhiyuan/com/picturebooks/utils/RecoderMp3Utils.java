...
public class RecoderMp3Utils {
    ...
    public static final int MAX_LENGTH = 1000 * 60 * 2;// 最大录音时长1000*60*2;
     ...
     * 文件存储默认sdcard/record
     */
    public RecoderMp3Utils() {
        //默认保存路径为/sdcard/record/下
        this(Environment.getExternalStorageDirectory().getAbsolutePath()+"/huib/record/");
    }

    public RecoderMp3Utils(String filePath) {
...
//            mMediaRecorder = new MediaRecorder();
        fileName = getRandomFileName() + ".mp3";  //TODO
        filePath = FolderPath + fileName;
        if (recorder == null) {
            recorder = new MP3Recorder(new File(filePath));
        }
        try {
...
//
//            fileName = getRandomFileName() + ".amr";  //TODO
//            filePath = FolderPath + fileName;
//
//            //3、准备
