 ...
 * Description ：年龄，lesson
 */

public class LessonAgeAdapter extends BaseQuickAdapter<MyLessonBean.DataBean, BaseViewHolder> {

    private Map<Integer, String> fitMap;

    public LessonAgeAdapter(int layoutResId, @Nullable List<MyLessonBean.DataBean> data) {
