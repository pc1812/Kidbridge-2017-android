...
public class WheelView extends View {
    ...
    private int getDesiredHeight(LinearLayout layout) {
        ...
        Log.e("mmmm", "getDesiredHeight: " + itemHeight);
    ...
    private int getItemHeight() {
        Log.e("pppp", "getItemHeight===1: " + itemHeight);
        if (itemHeight != 0) {
            return itemHeight;
        }
        ...
        if (itemsLayout != null && itemsLayout.getChildAt(0) != null) {
            ...
            Log.e("pppp", "getItemHeight: " + itemHeight);
            return itemHeight;
        }
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        // 绘制上边直线
        canvas.drawLine(getWidth() / 4, center - offset, getWidth() / 4 * 3, center - offset, paint);
        // 绘制下边直线
...
//                TextView tv = (TextView) itemsLayout.getChildAt(getCurrentItem());
//                tv.setTextColor(Color.BLUE);
                if (getParent() != null) {
