...
public class ToDayClockActivity_ViewBinding implements Unbinder {
  private ToDayClockActivity target;

  private View view2131689723;

  @UiThread
  public ToDayClockActivity_ViewBinding(ToDayClockActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ToDayClockActivity_ViewBinding(final ToDayClockActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ToDayClockActivity target = this.target;
