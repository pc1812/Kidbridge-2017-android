...
public class MyBridge_ViewBinding implements Unbinder {
  private MyBridge target;

  private View view2131689723;

  @UiThread
  public MyBridge_ViewBinding(MyBridge target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MyBridge_ViewBinding(final MyBridge target, View source) {
    this.target = target;
